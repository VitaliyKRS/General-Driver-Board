...
#ifndef __AK09918C_H__
#define __AK09918C_H__
...
/* Struct representing the axes data for magnetometer */
typedef struct {
    int16_t x;    // Mag data along the x-axis.
    int16_t y;    // Mag data along the y-axis.
    int16_t z;    // Mag data along the z-axis.
} mag_axes_t;
...
private:
    ...
    ak09918_mode_t mode;
    uint8_t buffer[16];    
    ak_data_t previous_data;                                
public:
    Ak09918c(const Ak09918c&) = delete;
    Ak09918c(const Ak09918c&&) = delete;
    void operator=(const Ak09918c &) = delete;
    void operator=(const Ak09918c &&) = delete; 
    static Ak09918c& instance();
    
    ak09918_err_t open(ak09918_mode_t ah09918c_mode);        
    void read(ak_data_t* data);                              
    ak09918_err_t close(void);                             
    char* resultToString(ak09918_err_t result);
